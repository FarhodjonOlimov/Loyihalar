...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $id = $_POST['id'];
    $tafsiyalar = $_POST['tafsiyalar'];

    $stmt = $conn->prepare("INSERT INTO imtihonga_qoyilgan_talab_korsatmalar (id,tafsiyalar) VALUES (?,?)");
    $stmt->bind_param("is",$id,$tafsiyalar);  
...
<body>
    <div class="container">
        ...
        <form method="post" action="">
            ...
            <label for="tafsiyalar">Tafsiyalar</label>
            <input type="text" name="tafsiyalar" required><hr>
