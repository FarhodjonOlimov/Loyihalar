...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("UPDATE umumiy_malumotlar SET akademik_daraja = ?,oqish_davomiyligi = ?,fan_nomi = ?,talim_shakli = ?,fan_tili = ?,fanga_ajratilgan_kredit = ?,ajratilgan_akademik_soat_hajmi_aud = ?,ajratilgan_akademik_soat_hajmi_must = ?,talim_yonalishi = ?,semestr = ?,fan_kodi = ?,fan_turi = ?,modulning_davomiyligi = ?,baholash_shakli = ?,auditoriya_soatlari_taqsimoti_maruza = ?,auditoriya_soatlari_taqsimoti_amaliy = ?  WHERE id = ?");
    $stmt->bind_param("issssssssssssssss",$id,$akademik_daraja,$oqish_davomiyligi,$fan_nomi,$talim_shakli,$fan_tili,$fanga_ajratilgan_kredit,$ajratilgan_akademik_soat_hajmi_aud,$ajratilgan_akademik_soat_hajmi_must,
        $talim_yonalishi,$semestr,$fan_kodi,$fan_turi,$modulning_davomiyligi,$baholash_shakli,$auditoriya_soatlari_taqsimoti_maruza,$auditoriya_soatlari_taqsimoti_amaliy);
...
<body>
    <div class="container">
        ...
        <form method="post" action="">
            ...
            <input type="text" name="baholash_shakli" required><hr>
