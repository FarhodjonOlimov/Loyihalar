...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $id = $_POST['id'];
    $vaziflar = $_POST['vaziflar'];
    $bajarish_soati = $_POST['bajarish_soati'];
    
    $stmt = $conn->prepare("INSERT INTO  muztaqil_talim_soatlarining_taqsimoti (id,vaziflar,bajarish_soati) VALUES (?,?,?)");
    $stmt->bind_param("iss",$id,$vaziflar,$bajarish_soati);  
...
<body>
    <div class="container">
        ...
        <form method="post" action="">
            ...
            <label for="vaziflar">Vazifalar</label>
            <input type="text" name="vaziflar" required><hr>
            <label for="bajarish_soati">Bajarish soati</label>
            <input type="text" name="bajarish_soati" required><hr>
