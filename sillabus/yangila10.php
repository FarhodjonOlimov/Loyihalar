...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("UPDATE fanni_baholash_mezoni_va_rejasi SET talabalar_bilimini_baholash_turlari = ?,joriy_baholash = ?,workshop = ?,loyiha_ishi = ?,vazifa_topshiriqlar = ?,davomat = ?,oraqliq_imtihon = ?,yakuniy_imtihon = ? WHERE id = ?");
