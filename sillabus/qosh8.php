...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO  qoshimcha_adabiyotlar (id,nomi,id_sillabus,royxatga_olish_vaqti) VALUES (?,?,?,?)");
    $stmt->bind_param("isis",$id,$nomi,$id_sillabus,$royxatga_olish_vaqti);  
...
<body>
    <div class="container">
        ...
        <form method="post" action="">
            ...
            <label for="royxatga_olish_vaqti">Royxatga olish vaqti sillabus</label>
